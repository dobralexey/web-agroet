...
import numpy as np
from src.web_agroet.geeet.common import is_img, is_xr
try: 
    import ee
except Exception:
    pass
...
def tseb_series(img=None,    # ee.Image with inputs as bands (takes precedence over numpy arrays)
    ...
    """
    from src.web_agroet.geeet.vegetation import compute_lai, compute_ftheta, compute_Rns
    from src.web_agroet.geeet.solar import compute_solar_angles, compute_Rn, compute_g
    from src.web_agroet.geeet.meteo import compute_met_params, compute_roughness
    from src.web_agroet.geeet.resistances import RN95
    from src.web_agroet.geeet.MOST import Ustar as compute_ustar
    from src.web_agroet.geeet.MOST import MOL
