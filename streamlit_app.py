...
TRANSLATIONS = {
    "en": {
        ...
        "success_message": "Processing completed! Use the download buttons below to save the results.",
    ...
    "ru": {
        ...
        "success_message": "Обработка завершена! Используйте кнопки ниже для скачивания результатов.",
